...
import { makeCreateBankAccountUseCase } from '@modules/accounts/use-cases/factories/make-create-bank-account-factory'
...
export async function createBankAccountController(
	...
	return reply.status(201).send(BankAccountsViewModel.toHTTP(account))
}
