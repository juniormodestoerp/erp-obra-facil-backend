...
import { makeSaveBankAccountUseCase } from '@modules/accounts/use-cases/factories/make-save-bank-account-factory'
...
export async function saveBankAccountController(
	...
	const { account } = await saveBankAccountUseCase.execute({
		id,
