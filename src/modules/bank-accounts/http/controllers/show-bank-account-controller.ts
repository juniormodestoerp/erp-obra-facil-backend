...
import { makeShowBankAccountUseCase } from '@modules/bank-accounts/use-cases/factories/make-show-bank-account-factory'
...
export async function showBankAccountController(
	...
	const { bankAccount } = await showBankAccountUseCase.execute({
		id,
	})
